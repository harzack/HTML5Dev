 ...
 */
 ...
 /**
 * NOTE: THIS FILE WAS MODIFIED BY OPEN TEXT CORPORATION.
 * 	The modifications made were:
 * 		function diff_prettyHtmlOrig was added.
 */
...
/* NOTE: THIS FUNCTION WAS ADDED BY OPEN TEXT CORPORATION. */
diff_match_patch.prototype.diff_prettyHtmlOrig = function(diffs, del, del2, ins, ins2)
{
  var html = [];
  var i = 0;
  for ( var x = 0; x < diffs.length; x++ )
  {
	...
	{
		case DIFF_INSERT:
			html[x] = ins + text + ins2;
			break;
		case DIFF_DELETE:
			html[x] = del + text + del2;
			break;
		case DIFF_EQUAL:
			html[x] = text;
			break;
