...
function showMenuCOP(m_No, eventObj, align) {
...
function startMenu(m_No, width) {
	...
	if (ns4) {
		document.write('<div id="menu' + m_No + '" name="menu' + m_No + '" class="myCommMenu">');
		document.write('<table ');
		if (width != null) {
...
function menuItem(label, m_No, width, onColour, offColour, url, myAlign) {	
	...
	if(ns4) {
		...
		document.write('<TR ><td class="CommSubMenu"');
		if (width != null) {
		 	document.write('width="100%" ');
		}
...
*/
		...
		if ( url != '' )
		{
			...
			document.write('><a class="MenuItemLink" href="#">');
			if (uMIB == 1) {
				if (m_No != null) document.write('<img src="' + sMBOff.src + '" width="' + sMBW + '" height="' + sMBH + '" border="0" align="left" name="menuBullet' + mI_No + '" id="menuBullet' + mI_No + '">');
				else document.write('<img src="' + mIBOff.src + '" width="' + mIBW + '" height="' + mIBH + '" border="0" align="left" name="menuBullet' + mI_No + '" id="menuBullet' + mI_No + '">');
			}
	...
	function menuLabel(label, m_No, width, onColour, offColour, url, align) {
		...
		if(ns4) {
			...
			if (align != null) document.write('return !showMenuCOP(' + m_No + ', event, \'' + align + '\'); ');
			...
			if (bC != null) {
				if (currentMenuLabel == 1) {
					...
					document.write('style="border-top: ' + bC + ' 0px solid; border-bottom: ' + bC + ' 0px solid; border-right: ' + bC + ' 0px solid;" ');
				}
			}
			...
			if (align != null) document.write('menuOver(); return !showMenuCOP(' + m_No + ', event,  \'' + align + '\');"  onmouseout="');
	...
	function writeSeparator(spacer) {
		document.write('<TR><TD style="border-bottom:1px solid #AAAAAA;margin:0px;padding:0px;" ><IMG SRC="' + spacer + '" HEIGHT="1" WIDTH="0"></TD></TR>\n');
	}
	
	function sideMenuLabel(label, m_No, width, onColour, offColour, url, align, classname) {
		tier[m_No] = 0;
		offColours[m_No] = offColour;
		onColours[m_No] = onColour;
		currentMenuLabel = currentMenuLabel + 1;
		...
		if(ns4) {
			...
			if ( url != '' )
			{
				...
				document.write('onmouseout="menuOut();" id="menuLabel' + m_No + '" name="menuLabel' + m_No + '" bgcolor="' + offColour + '">\n');
				if (uMLB == 1) {
					document.write('<img src="' + mLBOff.src + '" width="' + mLBW + '" height="' + mLBH + '" border="0" align="left" name="menuBullet' + m_No + '" id="menuBullet' + m_No + '">\n');
				}
				document.write('' + label + '</layer></ilayer><img src="images/shim.gif" width="1" height="1" border="0" align="right" id="label' + m_No + '" name="label' + m_No + '"></td>');
			}
			...
			document.write('<TR ><td CLASS="' + classname + '" width="' + width + '" align="left" bgcolor="' + offColour + '" valign="middle"  ');
			if (bC != null) {
				if (currentMenuLabel == 1) {
					document.write('style="border: ' + bC + ' 0px solid;" ');
				} else {
					document.write('style="border-left: ' + bC + ' 0px solid; border-bottom: ' + bC + ' 0px solid; border-right: ' + bC + ' 0px solid;" ');
				}
			}
			...
			if ( url != '' )
			{
				...
				document.write('&nbsp;' + label + '<img src="images/shim.gif" width="1" height="1" border="0" align="right" id="label' + m_No + '" name="label' + m_No + '"></div></td></tr>\n');
			}
		}		
	}	
